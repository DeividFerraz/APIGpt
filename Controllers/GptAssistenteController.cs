...
namespace ValorAproximado.Controllers
{
    ...
    public class GptAssistenteController : ControllerBase
    {
        ...
        #region "Criar Execução ass e thread"
        [HttpPost("execucao")]
            ...
            [FromServices] IConfiguration configuration)
        {
            ...
            if (respostaAssistente != null && respostaAssistente.Content != null && respostaAssistente.Content.Count > 0 && respostaAssistente.Content[0].Text != null)
            {
